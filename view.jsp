...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           ...
           for(int i=1;i<=page_num;i++) //建立1,2,...頁超連結
			   out.print("<a href='product_page2.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
...
//      current_page=2: SELECT * FROM `guestbook` ORDER BY `GBNO` DESC LIMIT 5, 3
//      current_page=3: SELECT * FROM `guestbook` ORDER BY `GBNO` DESC LIMIT 10, 3
           rs=con.createStatement().executeQuery(sql);
//  逐筆顯示, 直到沒有資料(最多還是5筆)
           while(rs.next())
                {
                 out.println("評價商品:"+rs.getString(3)+"<br>");
                 out.println("訪客姓名:"+rs.getString(2)+"<br>");

                 out.println("評價內容:"+rs.getString(4)+"<br>");
                 out.println("評價時間:"+rs.getString(5)+"<br><hr>");
          }
//Step 6: 關閉連線
          con.close();
      }
...
%>
<form name="form1" method="get" action="product_page.jsp">
<input type="submit" name="Submit" value="重新填寫" >
</form>
</body>
</html>
